...
Prácticas y misiones de la asignatura **Web Development I** (U-tad, 3.º).
...
Todos son HTML, CSS y JavaScript sin dependencias: basta con abrir el
`index.html` de cada carpeta en el navegador (o con Live Server).
